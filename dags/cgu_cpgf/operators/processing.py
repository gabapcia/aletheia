...
from cgu_cpgf.operators.file_storage import MINIO_BUCKET, MINIO_CONN_ID, FILEPATH_KEY
from cgu_cpgf.operators.database import INDEX_KEY
...
def _load_transactions(filepath: str) -> Iterator[Dict[str, Any]]:
    # Source: https://www.portaldatransparencia.gov.br/pagina-interna/603393-dicionario-de-dados-cpgf
    header = [
        'higher_agency_code',
        'higher_agency_name',
        'agency_code',
