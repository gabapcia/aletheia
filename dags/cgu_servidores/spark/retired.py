...
spark = SparkSession.builder.appName('CGU SERVIDORES - Retired').getOrCreate()
...
register_schema = StructType([
    ...
    StructField('codigo_tipo_aposentadoria', StringType(), nullable=False),
    StructField('tipo_aposentadoria', StringType(), nullable=False),
    StructField('data_aposentadoria', DateType(), nullable=False),
    ...
    StructField('data_diploma_ingresso_servico_publico', DateType(), nullable=False),
