...
from cgu_peti.operators.file_storage import MINIO_BUCKET, MINIO_CONN_ID, FILEPATH_KEY
from cgu_peti.operators.database import INDEX_KEY
...
def _load_people(filepath: str) -> Iterator[Dict[str, Any]]:
    ...
    for i, line in enumerate(reader):
        person = {
            ...
            'installment_status': line['installment_status'],
