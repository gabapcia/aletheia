...
from cgu_bpc.operators.file_storage import MINIO_BUCKET, MINIO_CONN_ID, FILEPATH_KEY
from cgu_bpc.operators.database import INDEX_KEY
...
def _load_people(filepath: str) -> Iterator[Dict[str, Any]]:
    header = [
        ...
        'cpf',
        'name',
        'legal_representative_nis',
        'legal_representative_cpf',
        'legal_representative_name',
        'benefit_number',
        'benefit_granted_in_court',
        'installment_value',
    ]
    ...
    for i, line in enumerate(reader):
        person = {
            '_id': i,
            'year_month_competence': f"{line['year_month_competence'][:4]}-{line['year_month_competence'][4:]}",
            ...
            'county': line['county'],
            'benefit_number': line['benefit_number'],
            'benefit_granted_in_court': line['benefit_granted_in_court'] == 'SIM',
            ...
            'legal_representative': {
                'nis': line['legal_representative_nis'],
                'cpf': re.sub(r'[^\d\*]', '', line['legal_representative_cpf']),
                'name': line['legal_representative_name'].upper(),
            },
        }
