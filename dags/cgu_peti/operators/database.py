...
from cgu_peti.operators.file_storage import FILEDATE_KEY
...
def elasticsearch(file_data: Dict[str, str]) -> Dict[str, str]:
    index_name = f"cgu-peti-people-{file_data[FILEDATE_KEY]}"
    people_index_conf = {
        "settings": {
        ...
        "mappings": {
            "properties": {
                ...
                "installment_status": {"type": "keyword", "index": False},
